...
pub fn main() !void {
    ...
    const master_seed = try key_mgmt.HDKeyManager.generate_master_seed(allocator, "enterprise_master_passphrase_2024", "kriptix_salt");
    ...
    try security.InputValidation.validate_key_size(secure_keypair.algorithm, secure_keypair.public_key, secure_keypair.private_key);
